...
Также возможно придется установить глобально [Gulp](http://gulpjs.com/) к себе на компьютер(если не установлен еще). Сделать это можно с помощью команды в консоли:
...
После чего запустится [Gulp](http://gulpjs.com/) и выполнит необходимые задачи и запустит сервер, главная страница сайта откроется в браузере автоматически, или же если нет, то в консоли выведутся локальные адреса по которым будет доступен сайт.
...
* **[Vladislav Semenets](mailto:semenecvlad@mail.ru)** - *Основная работа*
